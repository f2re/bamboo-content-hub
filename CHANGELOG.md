...
- После OAuth Meta и Pinterest хаб автоматически получает доступные Pages/Instagram accounts, Pinterest boards и разделы и предлагает выбор вместо ручного поиска ID.
